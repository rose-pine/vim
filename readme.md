<p align="center">
    ...
    <h2 align="center">Rosé Pine for Vim</h2>
</p>
...
If not already present, create the plugins directory as follows:<br><br>
```sh
mkdir -p $HOME/.vim/pack/plugins/start
```

Clone this repository to the plugins directory as follows:<br><br>
```sh
...
Clone the repository to your `RUNTIMEPATH` as follows:<br><br>
```sh
git clone --depth=1 https://github.com/rose-pine/vim $HOME/.vim/bundle/rosepine
```

Alternatively, add this repository as a `git` sub-module as follows:<br><br>
```sh
